...
- **[010-voice-pipeline.md](010-voice-pipeline.md)**: Optional voice module: local wake word, STT with remote-GPU/local fallback, pluggable brain (HA Assist or agent), ElevenLabs TTS with automatic Piper fallback, playback with barge-in, and the voice status widget.
